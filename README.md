...
| Total Funded Amount | Capital Deployed |
| Total Amount Received | Collection Performance |
| Average Interest Rate | Cost of Capital |
| Average Debt-to-Income Ratio (DTI) | Risk Assessment |
| Good Loan / Bad Loan | Portfolio Health (Classification) |
...
| Employee Length | Duration of the borrower's employment (used to gauge stability). |
| Employee Title | Borrower's occupation or job title. |
| Grade | Primary risk classification based on creditworthiness (Higher = Lower Risk). |
| Sub Grade | Refined risk assessment within the primary grade. |
| Home Ownership | Borrower's housing status (e.g., Mortgage, Rent, Own). |
| Issue Date | The date the loan was originated. |
| Last Payment Date | Date of the most recent loan payment received. |
| Loan Status | Current state of the loan (e.g., Fully Paid, Current, Default). |
| Purpose | The stated reason for the loan (e.g., debt consolidation, business). |
| Term | The duration of the loan in months (repayment period). |
...
| Instalment | Fixed monthly payment amount. |
